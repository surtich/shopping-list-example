...
function oauth (app, passport){
    ...
    passport.use(new GoogleStrategy({
        clientID: hero.config().oauth.login.google.client_id,
        clientSecret: hero.config().oauth.login.google.secret_key,
        callbackURL: hero.config().oauth.login.google.redirect_uri
    },
